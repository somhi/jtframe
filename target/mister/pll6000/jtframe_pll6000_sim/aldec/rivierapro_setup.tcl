...
# ACDS 20.1 720 linux 2022.04.14.18:22:24
# ----------------------------------------
...
# ----------------------------------------
# If jtframe_pll6000 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "jtframe_pll6000"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/intelFPGA_lite/20.1/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/jtframe_pll6000.vo"
}
